...
```bash
# macOS / Linux
docker run --name logilyzer -p 8742:8000 -v $(pwd)/outputs:/app/outputs ghcr.io/asinay/logilyzer:latest

# Windows PowerShell
docker run --name logilyzer -p 8742:8000 -v ${PWD}/outputs:/app/outputs ghcr.io/asinay/logilyzer:latest

# Windows CMD
docker run --name logilyzer -p 8742:8000 -v %cd%/outputs:/app/outputs ghcr.io/asinay/logilyzer:latest
```
